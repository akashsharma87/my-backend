  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'minimal-md': '0 4px 6px -1px rgba(0, 0, 0, 0.1)',
        'minimal-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.1)',
        'minimal-xl': '0 20px 25px -5px rgba(0, 0, 0, 0.1)',
        'inner-minimal': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.06)',
      },
      animation: {
